...
uint8_t SFRPAGE_save = SFRPAGE;
    ...
    enter_ADC0_Disable();
    PBCFG_0_switch_Interrupt_from_ADC0();
    EXTINT_0_enter_DefaultMode_from_RESET();
   // delay_ms(200);
    IE_EX0=1;
    IE_EX1=1;
...
extern void switch_ADC0_from_Interrupt(void) {
  ...
  PBCFG_0_switch_ADC0_from_Interrupt();
  ADC_0_enter_DefaultMode_from_RESET();
...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
 ...
 // TL0 = (0xff << TL0_TL0__SHIFT);
	...
	*/
	TH1 = (0x2b << TH1_TH1__SHIFT);//(0x96 << TH1_TH1__SHIFT);
	// [TH1 - Timer 1 High Byte]$
...
//		 | CKCON0_T1M__PRESCALE;	 
	...
	// $[TMOD - Timer 0/1 Mode]
	/*
	// T0M (Timer 0 Mode Select) = MODE0 (Mode 1, 16-bit Counter/Timer)
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	*/
	TMR2H = (0xB0 << TMR2H_TMR2H__SHIFT);//(0xFF << TMR2H_TMR2H__SHIFT);
	// [TMR2H - Timer 2 High Byte]$
	...
	*/
	TMR2L = (0x3F << TMR2L_TMR2L__SHIFT);//(0x01 << TMR2L_TMR2L__SHIFT);
	// [TMR2L - Timer 2 Low Byte]$
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	IE = IE_EA__DISABLED | IE_EX0__DISABLED | IE_EX1__DISABLED | IE_ESPI0__DISABLED
		 | IE_ET0__DISABLED | IE_ET1__DISABLED | IE_ET2__ENABLED | IE_ES0__ENABLED;//IE_ET2__ENABLED | IE_ES0__ENABLED;
	// [IE - Interrupt Enable]$

	// $[IP - Interrupt Priority]
	// [IP - Interrupt Priority]$
	//IP=0x80;
      //IP=0x80 | IP_PX0__LOW | IP_PX1__HIGH | IP_PS0__HIGH | IP_PT2__LOW;  
	// $[IPH - Interrupt Priority High]
	// [IPH - Interrupt Priority High]$
	//IPH =0x80;
   //  IPH =0x80 | IPH_PHX0__HIGH | IPH_PHX1__LOW |IPH_PHS0__HIGH | IPH_PHT2__LOW; 
